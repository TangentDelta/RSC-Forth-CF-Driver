...
FIRST DUP USE ! PREV !  ( SET UP THE BUFFER POINTER VARS )
0 OFFSET !  ( THIS SHOULD BE 0 )
EMPTY-BUFFERS ( GET THE BUFFERS READY )

' CFR/W CFA UR/W !  ( ACTIVATE THE CF MASS STORAGE DRIVER )
CFINIT  ( INITIALIZE THE CF CARD )
BASE !  ( RESTORE BASE )
